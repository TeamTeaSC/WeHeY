...
class Settings {
    ...
    var mwuPValueThreshold: Double {
        didSet {
            defaults.set(mwuPValueThreshold, forKey: DefaultKeys.mwuPValueThreshold)
        }
    }
    
    var corrPValThreshold: Double {
        didSet {
            defaults.set(corrPValThreshold, forKey: DefaultKeys.corrPValThreshold)
        }
    }
...
//    static let pfxPassword = "" // old password: weheiOSs1hTqETC8D
//    static let pfxPassword2 = "weheiOSs1hTqETC8D"
    static let metaDataserver = "wehe-metadata.meddle.mobi"
    let fallback_server = "wehe2.meddle.mobi"
    
    // TODO: Change property below to false when testing locally
    static let usingDefaultServer = false
    static let localPfxPassword = ""
    static var certFileName: String {
        return usingDefaultServer ? "ca2" : "ca"
    }
    static var pfxPassword: String {
        return usingDefaultServer ? "weheiOSs1hTqETC8D" : localPfxPassword
    }
    ...
    struct DefaultKeys {
        ...
        static let mwuPValueThreshold = "mwuPValueThreshold"
        static let corrPValThreshold = "corrPValThreshold"
        static let corrRatioThreshold = "corrRatioThreshold"
    }
    ...
    struct DefaultSettings {
        ...
        static let mwuPValueThreshold =  0.05
        static let corrPValThreshold = 0.05
        static let corrRatioThreshold = 0.50
    }
    ...
    init() {
        ...
        // localization defaults:
        if defaults.object(forKey: DefaultKeys.mwuPValueThreshold) != nil {
            mwuPValueThreshold = defaults.double(forKey: DefaultKeys.mwuPValueThreshold)
        } else {
            mwuPValueThreshold = DefaultSettings.mwuPValueThreshold
        }
        
        if defaults.object(forKey: DefaultKeys.corrPValThreshold) != nil {
            corrPValThreshold = defaults.double(forKey: DefaultKeys.corrPValThreshold)
        } else {
            corrPValThreshold = DefaultSettings.corrPValThreshold
        }
